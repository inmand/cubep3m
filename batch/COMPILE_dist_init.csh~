...
mpif77 -shared-intel -fpp -g -O3 -xhost -Dwrite_den -DBINARY -mt_mpi dist_init_dm.f90 -o dist_init -L$SCINET_FFTW_LIB -I$SCINET_FFTW_INC -lsrfftw_mpi -lsrfftw -lsfftw_mpi -lsfftw -lm -ldl 
