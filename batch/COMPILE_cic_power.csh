...
mpif77 -shared-intel -fpp -g -O3 -DBINARY -DPPINT -DNGP -mt_mpi cic_power_nu.f90 -o ngp_power_nu  -L$FFTWLIB -I$FFTWINC -lsrfftw_mpi -lsrfftw -lsfftw_mpi -lsfftw -lm -ldl
...
mpif77 -shared-intel -fpp -g -O3 -DBINARY -DPPINT -DNGP -mt_mpi cic_power_mem_check.f90 -o ngp_power_mem -L$FFTWLIB -I$FFTWINC -lsrfftw_mpi -lsrfftw -lsfftw_mpi -lsfftw -lm -ldl
